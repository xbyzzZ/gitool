...
function mediaUri(webview: vscode.Webview, extensionUri: vscode.Uri, fileName: string): string {
...
export function renderWebviewHtml(
  ...
  const scriptUri = escapeAttribute(mediaUri(webview, extensionUri, 'main.js'));
