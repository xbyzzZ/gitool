...
- 独立审查：布局边界、档位可用状态和圆环显示状态均通过复审；Codicon 样式优先级造成的空闲圆环常驻问题已关闭。
- 安装包：`gitool-file-commit-0.3.0.vsix` 共 15 个文件，不含 `history.js`；最终 SHA-256 为 `a0ff23f76c45dace96317d4c265dab90a35dde420a862581f315c531e69a05d7`。
